...
GSoC has attracted many students to join the open-source project like Wechaty, and they may become long-term contributors. Open-source projects always require both of new and old developers, so GSoC is a important program for us to recuiting young developers. GSoC provides a positive opportunity for students all over the world to become active participants in open source, and we hope to help it achieve mutual success.
...
Our contributors/committers community have 160+ peoples and it's a great place to sharing ideas, talking about the new features, and bug fixes. All GSoC students will be part of the community, and try to help them stay motivated. We believe that an open and active community is one of the best assets to retain contributors.
