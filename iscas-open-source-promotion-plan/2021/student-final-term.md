...
期末报告提交后会有一个 OSPP 的 Final-term Demo Day， 导师和学生会在线上进行期末汇报。提交的期末报告包括 Final-term Demo Day 的视频和期末报告内容总结。

期末报告要**以博客的方式提交到 [wechaty.js.org](https://github.com/wechaty/wechaty.js.org) Repo** 中，在提交报告之前，可以先阅读 [Wechaty 社区规范](https://wechaty.js.org/2021/06/23/the-wechaty-way/), 至少了解下面内容：
...
尤其要注意的是在博客发布规范中详细的介绍了如何提交博客、如何在博客中嵌入视频等，在期末中会用到，具体要求如下：
